    ...
    return (
        <div className="app">
            ...
            <div className="linkTreeContainer">
                ...
                <a href="https://www.youtube.com/channel/UC_MYMo3Qpq7HZzDt0rz_d3Q" target="_blank" className="link"><p className="pLink">Youtube</p></a>
                <a href="https://www.facebook.com/AutonomaIndustriale" target="_blank" className="link"><p className="pLink">Facebook</p></a>
                <a href="https://www.instagram.com/autonoma.industriale/?hl=it" target="_blank" className="link"><p className="pLink">Instagram</p></a>
            </div>
        </div>
    )
}